import { Q as Comp1, R as defineAsyncComponent, S as createRouter, U as createWebHistory, V as createWebHashHistory, W as useDark, X as useToggle, k as watch, Y as markRaw, E as reactive, d as defineComponent, r as ref, Z as watchEffect, o as openBlock, q as createBlock, _ as mergeProps, $ as resolveDynamicComponent, h as createCommentVNode } from "./vendor-dea00948.js";
...
let tree = [{ "group": true, "id": "design-system", "title": "Design System", "children": [{ "title": "Tailwind", "index": 1 }] }, { "title": "usage", "index": 0 }];
...
const clientSupportPlugins = {
  "vanilla": () => __vitePreload(() => import("./vendor-dea00948.js").then((n) => n.aM), true ? [] : void 0),
  "vue3": () => __vitePreload(() => import("./vendor-dea00948.js").then((n) => n.aN), true ? [] : void 0)
};
const __default__ = {
  inheritAttrs: false
};
